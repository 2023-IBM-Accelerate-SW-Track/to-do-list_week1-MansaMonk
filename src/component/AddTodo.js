    ...
    return (
      ...
      <div>
        <TextField
          ...
          data-testid="new-item-input" // Add data-testid attribute to the TextField component
        />
        <Button
          ...
          variant="contained"
          color="primary"
          data-testid="new-item-button" // Add data-testid attribute to the Button component
        >
          Add
        </Button>
      </div>
